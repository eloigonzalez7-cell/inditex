...
$issues = @(
  @{ title = "E0 — Bootstrap Webpack + React + TypeScript"; labels = "epic,story,sp-5,phase-1,done"; body = @"
## Story
As a developer, I want Webpack 5 + React + TypeScript from scratch so the project matches Inditex-style tooling.
...
**Estimate:** 5 SP
"@ },
  @{ title = "E1 — Data layer (AllOrigins + 24h cache)"; labels = "epic,story,sp-5,phase-2,done"; body = @"
## Story
...
**Estimate:** 5 SP
"@ },
  @{ title = "E2 — Home view (top 100 + live filter)"; labels = "epic,story,sp-8,phase-3,done"; body = @"
## Story
...
**Estimate:** 8 SP
"@ },
  @{ title = "E3 — Podcast detail"; labels = "epic,story,sp-8,phase-4,done"; body = @"
## Story
...
**Estimate:** 8 SP
"@ },
  @{ title = "E4 — Episode detail (audio + DOMPurify)"; labels = "epic,story,sp-5,phase-5,done"; body = @"
## Story
...
**Estimate:** 5 SP
"@ },
  @{ title = "E5 — App chrome (header + loading)"; labels = "epic,story,sp-3,phase-6,done"; body = @"
## Story
...
**Estimate:** 3 SP
"@ },
  @{ title = "E6 — Unit tests"; labels = "epic,story,sp-5,phase-7,done"; body = @"
## Acceptance
- [x] Cache TTL tests
...
**Estimate:** 5 SP
"@ },
  @{ title = "E7 — E2E + smoke"; labels = "epic,story,sp-5,phase-7,done"; body = @"
## Acceptance
- [x] Playwright happy path home → podcast → episode
- [x] ``npm run smoke`` on production build

**Estimate:** 5 SP
"@ },
  @{ title = "E8 — CI + release polish"; labels = "epic,story,sp-3,phase-8,done"; body = @"
## Acceptance
- [x] GitHub Actions CI
- [x] Coverage report
...
**Estimate:** 3 SP
"@ },
  @{ title = "E9 — Skeletons + code splitting"; labels = "epic,story,sp-3,phase-7,done"; body = @"
## Acceptance
- [x] Skeleton loaders
...
foreach ($issue in $issues) {
  gh issue create --repo $repo --title $issue.title --label $issue.labels --body $issue.body | Out-Host
}

Write-Host "Done. Open: https://github.com/$repo/issues"
Write-Host "Optional: create a Project board at https://github.com/$repo/projects and add these issues."
